...
export const MaterialsView: React.FC<MaterialsViewProps> = ({ setCurrentTab }) => (
  <div className="wr-catalog-page wr-taxonomy-page">
    <header className="wr-landing-hero wr-landing-hero--materials">
      <span className="wr-eyebrow">Material library</span>
      <h1>Start with the stone. Then narrow the surface.</h1>
      <p>Compare six material families, browse by color, or begin with the application before building a physical sample shortlist.</p>
    </header>
