  ...
  return (
    <div className="wr-about-page">
      ...
      <section className="wr-about-story wr-section-band wr-section-band--mist" aria-labelledby="about-story-title">
        <div><span className="wr-eyebrow">Our manufacturing approach</span><h2 id="about-story-title">Craft knowledge, industrial discipline, clear order documents.</h2><p>Our manufacturing approach combines material review, drawing-led fabrication, dimensional inspection, finish control, protective packing, and shipment preparation for repeat B2B programs.</p><Button variant="secondary" onClick={() => setCurrentTab('factory')}>Review the factory<ArrowRight /></Button></div>
