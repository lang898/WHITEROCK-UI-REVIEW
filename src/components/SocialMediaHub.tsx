  ...
  const posts: SocialPost[] = [
    {
      ...
      caption: 'Production Vietnam factory photo. Product dimensions, stone selection, sink model, and acceptance criteria are confirmed for each order.',
      author: 'WHITEROCK Website Draft',
      handle: 'WHITEROCK factory media',
      date: 'Draft',
    ...
    },
    {
      ...
      caption: 'Production Vietnam factory photo showing stone cutting equipment. Machine model, working range, and order allocation require current factory records.',
      author: 'WHITEROCK Website Draft',
      handle: 'WHITEROCK factory media',
      date: 'Draft',
    ...
    },
    {
      ...
      caption: 'Production Vietnam factory photo showing a stone cutting area. Equipment origin, model, and process capability are confirmed only in current factory records.',
      author: 'WHITEROCK Website Draft',
      handle: 'WHITEROCK factory media',
      date: 'Draft',
    ...
    },
    {
      ...
      caption: 'Production Vietnam factory photo showing stone processing activity. Available edge programs are confirmed against the approved sample and drawing.',
      author: 'WHITEROCK Website Draft',
      handle: 'WHITEROCK factory media',
      date: 'Draft',
    ...
    },
    {
      ...
      caption: 'Production Vietnam factory photo showing stone tops arranged on worktables. It is a production reference, not a named customer installation.',
      author: 'WHITEROCK Website Draft',
      handle: 'WHITEROCK factory media',
      date: 'Draft',
    ...
    },
    {
      ...
      caption: 'Production Vietnam factory photo showing stone racks and staged components. Material properties and test reports must be confirmed for the exact ordered product.',
      author: 'WHITEROCK Website Draft',
      handle: 'WHITEROCK factory media',
      date: 'Draft',
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-3 max-w-3xl">
          ...
          <p className="text-sm sm:text-base text-[#6e6e73] leading-relaxed">
            These unpublished website drafts use production factory photos. They do not represent verified customer projects, published social engagement, or product-specific test claims.
          </p>
        </div>
